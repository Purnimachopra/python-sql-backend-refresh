...
class Loan:
    ...
    def export_to_csv(self, filename):
        schedule = self.repayment_schedule()
...
if __name__ == "__main__":
    loan = Loan("Purnima Chopra", 400000, 8.5, 4)
    loan.export_to_csv("repayment_schedule.csv")
    print("CSV file generated: repayment_schedule.csv")
